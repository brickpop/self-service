...
/*
    globals module
*/
var _domain = 'https://pad.example.com/';
var safeDomain = 'https://sandbox.example.com';
...
module.exports = {
    ...
    contentSecurity: [
        ...
        "script-src 'self' " + safeDomain, // "script-src 'self'" + domain,
        ...
        "child-src blob: *",
        // IE/Edge
        "frame-src 'self' " + safeDomain + " blob:", // "frame-src blob: *",
         ...
         */
        "connect-src 'self' wss: blob:" + domain,
    ...
    padContentSecurity: [
        ...
        "child-src *",
        // IE/Edge
        "frame-src 'self' " + safeDomain + " blob:", // "frame-src *",
    ...
    ooContentSecurity: [
        ...
        // see the comment above in the 'contentSecurity' section
         "connect-src 'self' blob: wss:" + domain,
